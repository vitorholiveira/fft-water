...
uniform mat4 cameraMatrix;  // View matrix (rigid transform) of the camera
...
void main()
{
	...
	gl_Position = cameraMatrix * position; // gl_Position is the projected vertex position (in normalized device coordinates)
}
